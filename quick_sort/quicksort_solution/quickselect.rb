# Write an implace instance method on the Array class that will find
# the kth smallest elemtn in O(n) time.  You will likely want to use the
# partition method similar to the on in QuickSort.
# NB 1st smalles is the 0-th element in a sorted array.
